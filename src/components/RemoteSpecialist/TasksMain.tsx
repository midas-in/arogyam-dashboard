...
import { TaskTable } from '@/components/RemoteSpecialist/TaskTable';
...
export default function RemoteSpecialistTasks() {
        ...
        if (session?.accessToken) {
            const params = {
                ...
                query: {
                    ...
                    status: ['requested', 'completed', 'second-opinion'][activeTabIndex],
                    _count: limit,
    ...
    return <div className='lg:mx-[150px] lg:my-[50px] mx-[10px] my-[10px] justify-center'>
        ...
        <div className='mt-5 flex flex-col'>
            <Tabs
                tabs={['Pending', 'Completed', 'Second opinion']}
