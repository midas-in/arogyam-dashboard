    ...
    return (
        <div className='mt-4'>
            <ul className='border border-gray-300 rounded'>
                <li className="flex items-center justify-between mb-2 bg-primary-10 border-b border-gray-300 py-2 px-4">
                ...
                {imageIds.map((id, i) => (
                    <li key={i} className="flex items-center justify-between mb-2 border-b last:border-b-0 border-gray-300 py-2 px-4">
            ...
            <div className="flex justify-between items-center mt-4 bg-primary-10 border border-gray-300 rounded text-gray-600">
                <span className="font-light text-sm py-2 px-4">1 - 11 of 25 items</span>
                <div className='flex items-center '>
                    <span className="font-light text-sm border-l border-gray-300 py-3 px-4 text-gray-900 text-center h-full">
