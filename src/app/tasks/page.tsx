...
export default function Tasks() {
    ...
    }, [session?.accessToken, activeTabIndex])
    ...
    const onClick = (id?: string) => {
        router.push(`/tasks/${id}/diagnosis`);
    }

    return <div className='lg:mx-[150px] lg:my-[50px] mx-[10px] my-[10px] justify-center'>
        <div className="flex justify-between items-center pb-6 border-b border-gray-3">
        ...
        <div className='mt-4 flex flex-col'>
            ...
            />
            <TaskTable data={tasks} onClick={onClick} />
        </div>
    </div >
}
