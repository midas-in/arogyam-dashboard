  ...
  return (
    <div className="p-5 bg-white h-min w-full">
      <div className='flex justify-between items-center'>
        ...
        {(session?.permissions?.includes('EDIT_KEYCLOAK_USERS') || session?.permissions?.includes('FHIR_ALL_WRITE')) && <Link href='/admin/user-groups/new' className="border px-4 py-1 rounded bg-primary-400 text-white"> + Add group</Link>}
      </div>
      <div className="h-4" />
      <MyTable
        {...{
